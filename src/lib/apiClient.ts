...
class ApiClient {
  ...
  async inviteUser(data: { email: string; password: string; firstName?: string; lastName?: string; role?: string }) {
  ...
  async updateUser(id: string, updates: { email?: string; firstName?: string; lastName?: string; role?: string }) {
